        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Closures_Courts_CourtId",
                        column: x => x.CourtId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerHourSnapshot = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ThawaniSessionId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ThawaniInvoiceId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_BookingDate_CourtId_Status",
                table: "Bookings",
                columns: new[] { "BookingDate", "CourtId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Closures_CourtId",
                table: "Closures",
                column: "CourtId");

            migrationBuilder.CreateIndex(
                name: "IX_Closures_Date",
                table: "Closures",
                column: "Date");
